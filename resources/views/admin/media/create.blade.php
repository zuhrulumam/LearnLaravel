    ...
    <div class="graphs">
        ...
        <form method="post" id="createForm" class="form-horizontal">
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control1" placeholder="Meida Name" name="media_name" value="{{ old('media_name') }}">
                </div>
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-12">
                    <textarea class="form-control1" placeholder="Media Description" id="media_desc" name="media_desc">{{ old('media_desc') }}</textarea>
